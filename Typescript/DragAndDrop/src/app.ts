...
// Project Type
enum ProjectStatus { Active, Fisnished}
...
function validate(validatableInput: Validatable) {
    ...
    // a != null 은 a !== null && a != undefined 를 의미
...
class ProjectList extends Component<HTMLDivElement, HTMLElement> implements DragTarget {
    ...
    dropHandler(event: DragEvent) {
        ...
        projectState.moveProject(prjId, this.type === 'active' ? ProjectStatus.Active : ProjectStatus.Fisnished);
    }
